...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const navItems = [
    ...
    { name: 'Add Property', path: '/broker/add-property', icon: 'M12 4v16m8-8H4' },
    { name: 'Inquiries', path: '/broker/inquiries', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
    { name: 'Visit Requests', path: '/broker/visits', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { name: 'Profile Settings', path: '/broker/profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' }
  ];
