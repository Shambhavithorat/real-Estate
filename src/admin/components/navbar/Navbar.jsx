    ...
    <header className="bg-white border-b border-[#E5E5E5] h-[72px] flex items-center justify-between px-6 z-30 shrink-0">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center bg-[#F7F7F5] px-4 py-2.5 rounded-xl border border-[#E5E5E5] focus-within:border-[#6B705C] transition-colors">
          ...
          <input type="text" placeholder="Search dashboard..." className="bg-transparent border-none focus:ring-0 text-sm ml-2 w-64 text-[#111111] placeholder-[#666666]" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6">
         ...
         <div className="flex items-center gap-3 border-l border-[#E5E5E5] pl-4 md:pl-6 cursor-pointer">
            <div className="w-10 h-10 rounded-full bg-[#111111] text-white flex items-center justify-center font-bold text-sm">SA</div>
            <div className="hidden md:block">
               <p className="text-sm font-bold text-[#111111]">Super Admin</p>
               <p className="text-[9px] text-[#6B705C] uppercase tracking-widest font-bold">Owner</p>
            </div>
         </div>
      </div>
    </header>
